...
function App() {
  ...
  const tabs = [
    ...
    { id: 'assistant', label: 'Election Assistant', icon: <MessageSquare size={20} /> },
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      {/* Header */}
      <header className="bg-orange-900 text-white sticky top-0 z-50 shadow-md">
        ...
        {/* Mobile Navigation */}
        {isMobileMenuOpen && (
          <div className="md:hidden bg-orange-800 pb-3 pt-2 px-2 shadow-inner">
            {tabs.map(tab => (
              <button
                key={tab.id}
                onClick={() => {
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4 tracking-tight">
            Understand the <span className="text-orange-600">Indian Election</span> Process
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Your interactive guide to how democracy works in India, from voter registration to the formation of the government.
          </p>
        </div>
      ...
      <footer className="bg-gray-900 text-gray-400 py-8 text-center mt-12">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-sm">
            Designed for educational, non-partisan purposes.
          </p>
        </div>
      </footer>
    </div>
