  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
      <div className="bg-red-600 p-8 text-white text-center">
        ...
        <p className="text-red-100 max-w-lg mx-auto">Confused by political jargon? Search for any election term to get a simple, easy-to-understand definition.</p>
      </div>
      ...
      <div className="p-8">
        <form onSubmit={handleSearch} className="relative mb-8 max-w-2xl mx-auto">
          ...
          <input
            type="text"
            className="block w-full pl-11 pr-32 py-4 border-2 border-gray-200 rounded-xl leading-5 bg-gray-50 placeholder-gray-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-lg transition-all"
            placeholder="Search for terms like 'Filibuster', 'Delegate'..."
            value={searchTerm}
          ...
          <button
            ...
            className="absolute inset-y-2 right-2 bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 rounded-lg disabled:opacity-50 transition-colors"
          >
        ...
        <div className="max-w-2xl mx-auto">
          {definition && (
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-6 mb-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
